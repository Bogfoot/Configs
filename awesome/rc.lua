...
awful.screen.connect_for_each_screen(function(s)
	...
	s.mywibox:setup {
		...
		{ -- Right widgets
			...
			net_wired,
			-- weather_curl_widget({
			-- 	api_key = '5834297695b2514004b180f07b68cde8',
			-- 	coordinates = { 44.13, 15.22 },
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "e", function() awful.util.spawn("nautilus") end,
		{ description = "run Nautilus file manager.", group = "File Manager" }),
	...
	awful.key({ modkey }, "b", function() awful.util.spawn("brave-browser") end,
		{ description = "run brave-browser", group = "Internet" }),
...
for i = 1, 9 do
	globalkeys = gears.table.join(globalkeys,
		...
		awful.key({ "Ctrl" }, "Print", scrot_delay,
			{ description = "Take a screenshot of delay", group = "screenshot" }), awful.key({ modkey }, ',', function() xrandr.xrandr() end),
